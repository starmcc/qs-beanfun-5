...
|    功能    |              描述               |
|:--------:|:-----------------------------:|
| **登录方式** | 香港/台湾橘子 • 普通登录 • 双重登录 • 二维码登录 • GamaPass |
...
> v5.4.1之前，账密加密使用的是windows wmic组件，如系统缺少组件将使用默认加密密令(使用默认秘钥)！v5.4.2已进行优化!
...
<image style="width: 200px; height: 200px;" src="./resources/images/sponsor.png"></image>
