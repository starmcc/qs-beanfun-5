...
class Ui_About(object):
    def setupUi(self, About):
        ...
        self.label_image = QtWidgets.QLabel(parent=About)
        ...
        self.label_version = QtWidgets.QLabel(parent=About)
        ...
        self.label_qq = QtWidgets.QLabel(parent=About)
        self.label_qq.setStyleSheet("QLabel {color:black;}QLabel:hover {color: #F57C00;}")
        self.label_qq.setOpenExternalLinks(True)
        self.label_qq.setTextInteractionFlags(QtCore.Qt.TextInteractionFlag.LinksAccessibleByMouse)
